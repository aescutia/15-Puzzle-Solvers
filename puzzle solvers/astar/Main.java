...
/*
CS 411 HW 05: 15 Puzzle Solver using A* Search
By: Alexis Escutia
NetID: aescut3
UIN: 679743479
*/
...
class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Welcome to the 15 Puzzle Solver using A*!\n");
    ...
    while(!(input.equals(""))) {
      ...
      solution = solver.aStar(initial, Integer.valueOf(heuristic));
      
      endTime = System.currentTimeMillis();

      if(!(solution == null)) {
        System.out.println("\nThe solution to the puzzle is: " + solution.getPath());
